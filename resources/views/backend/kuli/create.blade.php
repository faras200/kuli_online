        ...
        <div class="card">
                        ...
                        <div class="row">
                            <div class="col col-12 col-lg-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" hidden class="form-control" name="role_id[]" id="role_id"
                                        value="3">
                                </div>
                            </div>
                            <div class="col col-12 col-lg-4">
                                <div class="form-group">
                                    ...
                                    <input type="email" hidden class="form-control" name="email" id="email"
                                        value="kuli{{ date('YmdHis') }}@gmail.com">
                                </div>
                            </div>
                            <div class="col col-12 col-lg-4">
                                <div class="form-group">
            ...
            <div class="card-footer">
                ...
                <button type="reset" name="reset" class="btn btn-danger"><i class="fa fa-sync"></i>
                    Reset</button>
                <a href="{{ route('kuli.index') }}" name="reset" class="btn btn-dark">
